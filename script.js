...
// function to call the movies in the data
      ...
      movieEl.innerHTML = `
          ...
          <div class="movie-info">
              ...
              <div class="movie-details">
                <p id="release_date" class="${release_date}">${release_date}</p>
